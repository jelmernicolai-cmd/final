...
function parseCsvToRows(text: string): Row[] {
  // simpele CSV parser (; of ,). Voor productiedata kun je eventueel csv-parse gebruiken.
...
export default function UploadAndDashboard() {
  ...
  async function onUpload(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      // Analyse client-side (werkt voor beide formaten)
      ...
      <div className="flex flex-col gap-3 md:flex-row md:items-end">
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-gray-500">
            Vereiste kolommen: <code>klant, sku, aantal_units, claimbedrag, omzet, periode (YYYY-MM)</code>
          </p>
        </div>
