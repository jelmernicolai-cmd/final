...
export const metadata: Metadata = {
  ...
  description:
    'PharmaGtN helpt farmafabrikanten hun gross-to-net en kortingsbeleid te optimaliseren met self-service analyses.',
  alternates: {
    canonical: '/',
  },
  openGraph: {
    title: 'PharmaGtN',
    description:
      'Optimaliseer gross-to-net en kortingsbeleid. Self-service platform voor farma.',
...
export default function RootLayout({
  ...
  // JSON-LD voor Organization (veilig via <Script id> i.p.v. inline object boven <html>)
  const orgJsonLd = {
