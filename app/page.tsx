      ...
      <section className="mx-auto max-w-6xl px-4 py-14">
        <div className="rounded-2xl border bg-white p-8 md:p-10">
          ...
          <p className="mt-3 text-gray-700">
            Ons motto is helder:{" "}
            <strong>minimaal €100.000 extra waarde</strong> via optimalisatie van je commerciële beleid.
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-6xl px-4 py-14">
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            {[
              {
                q: "Eindelijk één GTN-waarheid over alle kanalen, zonder spreadsheet-chaos.",
                a: "Director Market Access",
              },
              {
                q: "De consistentie-analyse gaf ons een helder kader voor discounts.",
                a: "Head of Commercial",
              },
              {
                q: "We zagen binnen weken paralleldruk op top-SKU’s — en stuurden direct bij.",
                a: "Pricing Manager",
              },
            ].map((t) => (
        ...
        <div className="mx-auto max-w-6xl px-4 py-14">
          ...
          <div className="mt-6 grid md:grid-cols-2 gap-6">
            ...
            <div className="rounded-xl border bg-white p-5">
              ...
              <p className="mt-2 text-sm text-gray-700">
                Licentie €2.500/jaar per entiteit. Enterprise-opties beschikbaar.
              </p>
            </div>
            <div className="rounded-xl border bg-white p-5">
