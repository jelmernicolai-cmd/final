    ...
    <div className="mx-auto max-w-6xl px-3 sm:px-4 lg:px-6 py-6 space-y-6">
      ...
      <header className="rounded-2xl border bg-white p-4 sm:p-5">
        ...
        <p className="text-sm text-gray-700 mt-1">
          Upload je <b>AIP-master</b> en de <b>Staatscourant-PDF</b>. We scannen pagina’s gericht op jouw REGNR’s en nemen de
          prijs van die pagina over. Geen server, werkt ook met héle grote PDF’s.
        </p>
      </header>
